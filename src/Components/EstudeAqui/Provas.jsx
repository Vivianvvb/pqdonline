...
import ProvaA from "../../files/ProvaCatA.pdf"
import ProvaB from "../../files/ProvaCatB.pdf"
import ProvaC from "../../files/ProvaCatC.pdf"
import ProvaD from "../../files/ProvaCatD.pdf"
...
const [opcaoSimulado, setOpcaoSimulado] = useState("")
let quizz = []
...
const verifyAnswer = () => {
    ...
    return(
        ...
        <select id="CategoriaSimulado" value={opcaoSimulado} onChange={(e) => setOpcaoSimulado(e.target.value)}>
            <option>Selecione uma opção:</option>
            <option>Alunos AFF</option>
